import 'package:flutter_app_updated/flutter_maps/quakes_app/util/type_helper.dart';
...
class quakes_model {
  ...
  quakes_model({this.type, this.metadata, this.features, this.bbox});

  quakes_model.fromJson(Map<String, dynamic> json) {
    type = json['type'];
